      ...
      {open && (
        <div className="absolute w-screen h-screen top-0 left-0 bg-black bg-opacity-65 flex items-center justify-center z-50">
          <form
            ...
            {state.error && (
              <span className="text-red-500">Something wen wrong</span>
            )}
            <div
              className="absolute top-3 right-3 px-4 py-2 cursor-pointer bg-blue-500 text-white rounded-tl-lg rounded-br-lg"
              onClick={handleClose}>
              X
            </div>
          </form>
